...
?>
	<div class="contener">
		...
		<div class="band">
			<div>
			<label class="text11"> <a href="liste_quest.php">Lister Question </a></label>
			<label class="text11"> <a href="creerAdmin.php"> Creer Admin </a></label>
			<label class="text11"><a href="liste_joueur.php">Listre jouers</a></label>
			 </div>
			...
			<div class="form">
				<div class="profil">
					...
					<div class="roundeImage">
						<img style=" width: 90px;height: 90px;border-radius: 50%; " src="../asset/img/lds.jpg">
						<a href="millieurScore.php">	<img style="width: 90px; height:30px ;margin-right:3px" src="../asset/img/unnamed.jpg"></a>
					</div>
